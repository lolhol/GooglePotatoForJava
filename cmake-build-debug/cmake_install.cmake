...
if(CMAKE_INSTALL_COMPONENT STREQUAL "Unspecified" OR NOT CMAKE_INSTALL_COMPONENT)
  if(EXISTS "$ENV{DESTDIR}/usr/lib/jni/libcartographer4java.so" AND
    ...
    file(RPATH_CHECK
         FILE "$ENV{DESTDIR}/usr/lib/jni/libcartographer4java.so"
         RPATH "")
  endif()
  list(APPEND CMAKE_ABSOLUTE_DESTINATION_FILES
   "/usr/lib/jni/libcartographer4java.so")
  ...
  if(EXISTS "$ENV{DESTDIR}/usr/lib/jni/libcartographer4java.so" AND
    ...
    if(CMAKE_INSTALL_DO_STRIP)
      execute_process(COMMAND "/usr/bin/strip" "$ENV{DESTDIR}/usr/lib/jni/libcartographer4java.so")
    endif()
  endif()
endif()
...
if(CMAKE_INSTALL_COMPONENT STREQUAL "Unspecified" OR NOT CMAKE_INSTALL_COMPONENT)
  if(EXISTS "$ENV{DESTDIR}/usr/lib/jni/libcartographer4java3D.so" AND
    ...
    file(RPATH_CHECK
         FILE "$ENV{DESTDIR}/usr/lib/jni/libcartographer4java3D.so"
         RPATH "")
  endif()
  list(APPEND CMAKE_ABSOLUTE_DESTINATION_FILES
   "/usr/lib/jni/libcartographer4java3D.so")
  if(CMAKE_WARN_ON_ABSOLUTE_INSTALL_DESTINATION)
    message(WARNING "ABSOLUTE path INSTALL DESTINATION : ${CMAKE_ABSOLUTE_DESTINATION_FILES}")
  endif()
  if(CMAKE_ERROR_ON_ABSOLUTE_INSTALL_DESTINATION)
  ...
  if(EXISTS "$ENV{DESTDIR}/usr/lib/jni/libcartographer4java3D.so" AND
     NOT IS_SYMLINK "$ENV{DESTDIR}/usr/lib/jni/libcartographer4java3D.so")
    if(CMAKE_INSTALL_DO_STRIP)
      execute_process(COMMAND "/usr/bin/strip" "$ENV{DESTDIR}/usr/lib/jni/libcartographer4java3D.so")
    endif()
  endif()
endif()
